...
| **외부 api** | ohoo 이미지 편집, 1688 api sdk, cj대한통운 송장정보 api |
...
### 1. https://embed.cunlim.dev AI 카테고리 추천 서비스 (포트폴리오 프로젝트) - 풀스택 개발자
- **기간:** 2026.04.17 ~ 2026.06.07 (1~2개월)
- **역할:** 풀스택 개발자 (1명)
- **사용 기술 및 인프라:** Linux(WSL2 + CloudFlare Tunnel), Docker, Github Actions CI/CD, Laravel, Next.js, Shadcn, PostreSQL(pgvector), ollama
