...
## [소개]
- 3년간 스타트업에서 신규제품의 프로토타이핑, 기존제품의 고도화를 위해 요구사항 수집, 기술 검토, 성능 최적화, 다양한 방안 제안 등 다양한 업무를 서버 운영부터 프로젝트 개발까지 전담한 실무 경험이 있습니다.
- 기술의 진보에 따라 맹목적인 유행은 쫓지 않지만 현대적인 동시에 검증된 기술을 적극 도입해보고 있습니다. 예로 회사 업무 중 필요에 따라 Git, Docker, Vue.js, Xdebug 를 도입했었고 개인 프로젝트에서는 인프라 현대화, AI 개발, CI/CD 구축 등 업무 자동화를 시도해보았습니다.
- 원활한 한국어 기반의 협업이 가능하며, F-4 비자 소지자로 고용 절차상 제약이 없습니다.
...
- **주요 성과:**
  ...
  - **업무요청에 맞게 신규 기술 도입:** PyPDF2(Python), Express(Node.js), Vue(CDN), Chrome Extension, C# terminal app 도입
