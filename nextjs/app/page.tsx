        ...
        <div className="mx-auto flex h-14 max-w-5xl items-center justify-between px-5">
          ...
          <div
            dangerouslySetInnerHTML={{
              __html: `
<button data-theme-toggle onclick="toggleTheme()" class="relative inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none hover:bg-muted hover:text-foreground dark:hover:bg-muted/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring" aria-label="테마 전환">
