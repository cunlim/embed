...
> **📘 최신 API 문서**: docs 페이지의 **[API 연동 가이드](/docs?doc=API_V1)** 에서 더 상세한 파라미터 설명과 Swagger/OpenAPI 사용법을 확인할 수 있습니다. 본 문서는 API v1 사양의 참조용 스펙입니다.

카테고리 유사도 검색 기능을 호출할 수 있는 REST API입니다.

## 개요

CL Embed API는 카테고리 데이터에 대한 유사도 검색을 제공합니다. API Key를 활용하여 카테고리 검색 결과를 JSON 형식으로 받아볼 수 있습니다.
